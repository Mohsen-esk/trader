...
<div class="auth-container">
    <div class="auth-card">
        ...
        <h1 class="auth-title">ایجاد حساب کاربری</h1>
        ...
        <form action="{{ route('register.post') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" placeholder="نام و نام خانوادگی خود را وارد کنید" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" id="password_confirmation" name="password_confirmation" placeholder="رمز عبور خود را تکرار کنید" required>
            </div>
            ...
            <div class="terms-text">
                با ثبت نام در سایت، شما <a href="#">شرایط استفاده</a> و <a href="#">سیاست حریم خصوصی</a> ما را می‌پذیرید.
            </div>
        </form>
        
        <div class="auth-divider">
            <div class="auth-divider-line"></div>
            <div class="auth-divider-text">یا ثبت نام با</div>
            <div class="auth-divider-line"></div>
        </div>
